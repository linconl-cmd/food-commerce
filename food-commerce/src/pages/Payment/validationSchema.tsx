...
export const schema = yup
  .object({
    fullName: yup
      ...
      .matches(/(\w.+\s).+/gi, "O nome deve conter nome e sobrenome."),
    email: yup.string().required("O email é obrigatório.").email("O email deve ser válido."),
    mobile: yup
      .string()
      .required("O celular é obrigatório.")
      .transform((value) =>  value.replace(/[^\d]/g,""))
      .test("validateMobile", "Celuar inválido.", (value) => isValidPhone(value)),
    document: yup
      .string()
      .required("O CPF/CNPJ é o obrigatório.")
      .transform((value) => value.replace(/[^\d]/g,""))
